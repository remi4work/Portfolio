...
function About() {
    return (
        <section id='about' className='wrapper'>
            ...
            <div className='about'>
                <h1>About•Me</h1>
                <p><span className="highlight">🚀</span> Hello there! <span className="highlight">:&gt;</span> I&apos;m Remi, a <span className="highlight">full stack web developer</span> with an interest in everything and a life-long dedication to learning. With an experience of <span className="highlight">5+ years</span> in <span className="highlight">freelancing</span> and <span className="highlight">20+ projects</span>, I started coding in <span className="highlight">2018</span> and now I am into fulltime <span className="highlight">freelance</span>. I enjoy creating things that live on the internet. <span className="highlight">🌐</span></p>
            </div>
        </section>
    )
}
